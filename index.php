        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav navbar-right">
                    <li class="active">
                        <a href="contact.html">หาของกิน</a>
                    </li>
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">กินขนมกัน <b class="caret"></b></a>
...
<span id="result"></span></p>
                ...
                <p><i class="fa fa-phone"></i> 
                    <abbr title="Phone">P</abbr>: (+66) 89 202 7882</p>
                <p><i class="fa fa-envelope-o"></i>
                    <abbr title="Email">M</abbr>: timbercafe@hotmail.com</p>
                <p><i class="fa fa-clock-o"></i> 
                    <abbr title="Hours">H</abbr>: Monday - Sunday: 11:00 AM to 8:00 PM</p>
